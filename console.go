...
func init() {
	ConsoleLogger.info = log.New(os.Stdout, "INFO: ", log.Ldate|log.Ltime)
	ConsoleLogger.warn = log.New(os.Stderr, "WARNING: ", log.Ldate|log.Ltime)
	ConsoleLogger.err = log.New(os.Stderr, "ERROR: ", log.Ldate|log.Ltime)
}
